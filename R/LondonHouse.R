...
#' \describe{
#'   \item{PURCHASE}{Purchase price of the property.}
#'   \item{FLOORSZ}{Size of the property in square metres.}
#'   \item{BATH2}{Is 1 if the property has 2 or more bathrooms, 0 otherwise.}
